...
class PorcupineWakeWordDetector(
    ...
    fun start() {
        try {
            val keywordFile = copyAssetToFile("Whisper_en_android_v3_0_0.ppn") // 각 AccessKey를 사용해 다운받은 파일
            ...
            porcupineManager = PorcupineManager.Builder()
                .setAccessKey("OxT4JYyoL08s550N8gSunZMsgEmxkFJoAdkQiI7spvE3Y2Dwza8i3g==") // AccessKey
